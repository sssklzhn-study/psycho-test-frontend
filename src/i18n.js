...
"admin.modal.date": "Дата",
          ...
          "result.retest.title": "Требуется повторное тестирование",
"result.retest.message": "Ваши ответы недостаточно достоверны.",
"result.retest.note": "Пожалуйста, пройдите тест повторно через 2 недели для получения достоверных результатов.",
    ...
    "button": "📝 Зарегистрироваться"
      ...
      kk: {
        translation: {
          ...
          "nav.home": "Басты бет",
          "result.retest.title": "Қайта тестілеу қажет",
"result.retest.message": "Сіздің жауаптарыңыз жеткілікті дәрежеде сенімді емес.",
"result.retest.note": "Өтінеміз, сенімді нәтиже алу үшін тестілеуді 2 аптадан кейін қайта тапсырыңыз.",
          // ========== ШКАЛЫ (ПОЛНЫЕ НАЗВАНИЯ) ==========
